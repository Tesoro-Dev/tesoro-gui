...
<context>
    ...
    <message>
        ...
        <translation>Це полегшує надсилання та отримання Tesoro і знижує кількість помилок при введенні адрес вручну.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>ПОПЕРЕДЖЕННЯ: Не використовуйте повторно свої ключі Tesoro в іншому форку, ЯКЩО ТІЛЬКИ цей форк не має вбудованих засобів захисту від компрометації введених ключів. Подібні дії можуть зашкодити вашій конфіденційності.</translation>
    </message>
    <message>
        ...
        <translation>УВАГА: Копіювання вашої мнемонічної фрази в буфер обміну може супроводжуватися перехопленням цих даних різним шкідливим програмним забезпеченням, яке відправить вашу мнемоніку зловмисникові, після чого ваші Tesoro можуть бути вкрадені. Будь ласка, введіть вашу мнемонічну фразу вручну з клавіатури.</translation>
    </message>
    <message>
...
Mining also gives you a small chance to earn some Tesoro. Your computer will create hashes looking for block solutions. If you find a block, you will get the associated reward. Good luck!</source>
        <translation>Майнінг на вашому комп&apos;ютері допомагає зміцнити мережу Tesoro. Чим більше людей майнять, тим важче атакувати мережу, кожний може допомогти.

Майнінг також дає маленький шанс отримати Tesoro. Ваш комп&apos;ютер буде створювати хеші в пошуку вирішення блоку. Якщо ви знайдете блок, то получите винагороду! Щасти!</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вбудована версія Tesoro: </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Використовувати сторонній вузол для підключення до мережі Tesoro. Менш безпечно, але більш зручно.</translation>
    </message>
    <message>
        ...
        <translation>Щоб отримати список віддалених нод, введіть &apos;Tesoro remote node&apos; у вашій улюбленій пошуковій системі. Будь ласка, переконайтеся, що обраній ноді можна довіряти.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>На цій сторінці можна взаємодіяти із загальною базою даних RingDB. Ця база даних призначена для використання гаманцями Tesoro або їх клонів, які зможуть повторно використовувати ключі Tesoro.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Для того щоб приховати які входи в транзакціях Tesoro були витрачені, третя сторона не повинна повідомляти які входи в кільці вже задіяні в витраті. Адже якщо це зробити, то це послабить захист, який забезпечується кільцевими підписами. Якщо відомо, що всі, крім одного з входів, вже витрачені, то фактично трата входу стає очевидною, тим самим анулюється ефект кільцевих підписів, одного з трьох основних рівнів захисту конфіденційності Tesoro.&lt;br&gt;Щоб допомогти транзакціям уникнути витрати цих входів, можна використовувати список відомих витрачених входів, щоб уникнути їх використання в нових транзакціях. Такий список підтримується проектом Tesoro і доступний на веб-сайті getmonero.org, і ви можете імпортувати цей список тут.&lt;br&gt;Крім того, ви можете просканувати блокчейн (і блокчейни клонів Tesoro) самостійно, використовуючи інструмент tesoro-blockchain-mark-spent-outputs, щоб створити список відомих витрачених входів.&lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Щоб уникнути скасування захисту, що забезпечується кільцевими підписами Tesoro, вихід не повинен проводитися з різними кільцями на різних блокчейнах. Хоча це як правило не викликає занепокоєння, він може стати одним, якщо якийсь клон Tesoro, що використовує ключ повторно, дозволяє вам витрачати існуючі виходи. В цьому випадку вам необхідно забезпечити, щоб ці існуючі виходи використовували одне і те ж кільце для обох блокчейнів.&lt;br&gt;Це може бути зроблено автоматично, або будь-яким програмним забезпеченням з можливістю повторного використання ключів, яке не спробує позбавити вас конфіденційності.&lt;br&gt;Якщо ви використовуєте клон Tesoro з повторним використанням ключа, і цей клон не включає цей захист, ви все одно можете гарантувати, що ваші транзакції будуть захищені, зробивши їх спочатку на клоні, потім вручну додати кільце на цій сторінці, що дозволить вам конфіденційно перевести ваші Tesoro.&lt;br&gt;Якщо ви не використовуєте клон Tesoro з повторним використанням ключів без цих функцій безпеки, то вам не потрібно нічого робити, оскільки все автоматизовано.&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>Тут записуються кільця, що використовуються виходами проведеними на Tesoro, так що одне і те ж кільце можна використовувати повторно, щоб уникнути проблем з конфіденційністю.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Введіть адресу Tesoro (наприклад: 44AFFq5kSiGBoZ...)</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Tesoro відправлено успішно</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Щоб мати можливість обмінюватися даними з мережею Tesoro, ваш гаманець повинен бути підключений до ноди Tesoro. Для кращої конфіденційності рекомендується запустити свою власну ноду.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Окрім цього, ви можете вказати ноду швидкого завантаження, щоб негайно почати користуватися Tesoro.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вас вітає Tesoro.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Виберіть цю опцію, якщо ви вперше користуєтесь Tesoro.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Змінити мову графічного інтерфейсу Tesoro.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Тимчасове використання віддалених нод зручно для негайного використання Tesoro (звідси назва &quot;початкове завантаження&quot;), однак пам&apos;ятайте, що при використанні віддалених нод (включаючи вибір початкового завантаження), ноди можуть відстежувати вашу IP адресу, відстежувати вашу &quot;висоту відновлення&quot; і відповідні дані запиту блоку, і відправляти вам неточну інформацію, щоб дізнатися більше про здійснені вами транзакції.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Цей режим ідеально підходить для управління невеликими сумами Tesoro. У вас є доступ до основних функцій для здійснення транзакцій та управління ними. Програма автоматично підключиться до мережі Tesoro, щоб ви відразу могли почати використовувати Tesoro.</translation>
    </message>
    <message>
...
If you don&apos;t have the option to run your own node, there&apos;s an option to connect to a remote node.</source>
        <translation>Щоб мати можливість обмінюватися даними з мережею Tesoro, ваш гаманець повинен бути підключений до ноди Tesoro. Для кращої конфіденційності рекомендується запустити свою власну ноду.
...
може знадобитися ваша участь.</translation>
    ...
    <message>
        ...
        <translation>Tesoro успішно відправлені: %1 транзакция(й) </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TSX, із %2 підтвердженням(и).</translation>
    </message>
    <message>
        <location filename="../main.qml" line="1068"/>
        <source>Good signature</source>
    ...
    <message>
        ...
        <translation>Цей адрес отримав %1 TSX, але транзакція ще не була підтверджена майнерами</translation>
    </message>
    <message>
